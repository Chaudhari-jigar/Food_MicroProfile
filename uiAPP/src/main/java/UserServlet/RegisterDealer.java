...
public class RegisterDealer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RegisterDealer</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RegisterDealer at " + request.getContextPath() + "</h1>");
            out.println("<Form method='post' action='/uiAPP/ViewUsers'>"
                    + "UserName:-<input type='text' name='dUserName' placeholder='Enter UserName here ... '/></br></br>"
                    ...
                    + "<input type='hidden' name='Role' value='4'/></br></br>"
